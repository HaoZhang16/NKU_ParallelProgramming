...
int main(int argc, char *argv[])
{
    ...
    auto fs_base = LoadData<uint8_t>(data_path + "DEEP100K.base.100k_4_16.quantized.bin", base_number, cluster_num);
    auto fs_center = LoadData<float>(data_path + "DEEP100K.base.100k_4_16.center.bin", fs_center_num, center_vecdim);
    fs_center_num /= 4;
	// 只测试前2000条查询
    test_number = 2000;
    ...
    for(int i = 0; i < test_number; ++i) {
        ...
        // fs_simd
        auto res = fs_simd_search(fs_base, fs_center, test_query + i*vecdim, base_number, vecdim, k, fs_center_num, center_vecdim, base);
